    ...
    def run(self, checksd=None, start_event=True, configs_reloaded=False):
        ...
        if Platform.is_windows():
            ...
            try:
                ...
                with statsd.timed('system.collector.run_time', tags=["version:5.6.0"], use_ms=True):
                ...
                # Old system metric collector
                with statsd.timed('system.collector.run_time', tags=["version:5.5.x"], use_ms=True):
